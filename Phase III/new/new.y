...
exp_stmt : single_variable // if(!undeclare_check($1,curr_scope)) cout<< undeclaration error<<endl;
...
single_variable_2 : single_variable {
                          ...
                          if(is_func_bool){
                          var_records* rec = new var_records{$1, type,convert_scope_to_string(find_curr_scopes_len(curr_scopes))};
                          fn_var_entry(rec);
                          }
                        else{
                          add('V');
